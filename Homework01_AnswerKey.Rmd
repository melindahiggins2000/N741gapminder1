...
The minimum life expectancy is `r round(min(gapminder$lifeExp), digits=2)` years and the maximum life expectancy is `r round(max(gapminder$lifeExp), digits=2)`.

## =========================================
## ANSWER KEY - HOMEWORK 01 - TASK 1

For this dataset with `r round(length(gapminder$lifeExp), digits=2)` cases (i.e. "sample size"), the median life expectancy is `r round(median(gapminder$lifeExp), digits=2)` years and the standard deviation for life expectancy is `r round(sd(gapminder$lifeExp), digits=2)`.
